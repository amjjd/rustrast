...
pub trait AvxFragmentShader<const EXECUTE_FRAGMENT_SHADER: bool, T : Copy> : Send + Sync {
     ...
     * 
     * # Returns
     * - RGB10_A2 colour values for the 8 fragments or RGBA for NOAA.
     */
    unsafe fn fragment(&self, it: usize, p_w0: __m256, p_w1: __m256, p_w2: __m256, e0: T, e1: T, e2: T) -> __m256i;
}
...
impl AvxFragmentShader<SKIP_FRAGMENT_SHADER, ()> for NullFragmentShader {
    unsafe fn fragment(&self, _it: usize, _p_w0: __m256, _p_w1: __m256, _p_w2: __m256, _extra0: (), _extra1: (), _extra2: ())-> __m256i {
        _mm256_undefined_si256() // won't be called
    }
}