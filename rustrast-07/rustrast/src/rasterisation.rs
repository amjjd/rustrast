...
pub fn fill_triangle<T : Copy>(
        ...
        e0: T, e1: T, e2: T,
        iarea: f32, tl: u8,
        shader: &impl AvxFragmentShader<T>) {
                ...
                while yp < ymax as isize {
                    ...
                    while xp < xmax as isize {
                        ...
                        if _mm256_testz_si256(inside_mask, inside_mask) == 0 {
                            ...
                            if (_mm256_testz_si256(depth_mask, depth_mask) == 0) {
                                let filled_span = shader.fragment(it, w0, w1, w2, p_w0, p_w1, p_w2, e0, e1, e2);
